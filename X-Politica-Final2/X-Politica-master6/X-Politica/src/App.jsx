...
import ClaimsPieChart from './components/Stats.jsx';
import ClaimsBarChart from './components/Graph.jsx';
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/howUse" element={<Instructions />} />
        <Route path="/stats" element={<ClaimsPieChart />} />
        <Route path="/graphs" element={<ClaimsBarChart />} />
